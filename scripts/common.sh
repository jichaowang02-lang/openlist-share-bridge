...
BAIDU_OPENLIST_ADMIN_USERNAME=${ADMIN_USERNAME:-admin}
...
BAIDU_OPENLIST_GUEST_GLOBAL_DAILY_LIMIT=${GUEST_GLOBAL_DAILY_LIMIT:-100}
BAIDU_OPENLIST_GUEST_MAX_SINGLE_FILE_BYTES=${GUEST_MAX_SINGLE_FILE_BYTES:-10737418240}
BAIDU_OPENLIST_GUEST_COOLDOWN_SECONDS=${GUEST_COOLDOWN_SECONDS:-60}
BAIDU_OPENLIST_GUEST_MAX_ACTIVE_TASKS=${GUEST_MAX_ACTIVE_TASKS:-2}
BAIDU_OPENLIST_GUEST_MAX_ACTIVE_TASKS_PER_USER=${GUEST_MAX_ACTIVE_TASKS_PER_USER:-1}
...
BAIDU_OPENLIST_WORKER_COUNT=${WORKER_COUNT:-1}
